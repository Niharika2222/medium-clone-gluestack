...
const Layout = () => {
  ...
  return (
    <Box h={"$16"} borderBottomWidth="$1" borderBottomColor="$trueGray200">
      {loading ? (
        <HStack
          ...
          px="$10"
        >
          <HStack justifyContent="center" alignItems="center" space="2xl">
            <Box w={50}>
          ...
          <Box>
            <HStack space="2xl">
              ...
              >
                <Avatar bgColor="#088F8F" size="sm" borderRadius="$full">
                  <AvatarFallbackText>
        ...
        <HStack
          ...
          marginTop={"$1"}
        >
          <Box h={50} w={180} justifyContent="center">
